...
delete("/user/grocery/:id",Auth(process.env.USER_TOKEN_KEY),deleteValidation.get,groceryController.delete).
put("/user/grocery/:id",Auth(process.env.USER_TOKEN_KEY),updateValidation.update,groceryController.update)
